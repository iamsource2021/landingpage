  ...
  return (
    ...
    >
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Política de privacidad | Términos y condiciones"
        {...getOverrideProps(
          overrides,
      ...
      >
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="¡Conéctate con nosotros!"
          {...getOverrideProps(
            overrides,
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="¡Descubre cómo podemos impulsar juntos el crecimiento de tu empresa! Estamos aquí para ayudarte en tu viaje hacia la transformación digital y brindarte el soporte necesario. ¡Contáctanos hoy mismo!"
          {...getOverrideProps(
            overrides,
