...
export default function ContentsUpdateForm(props) {
  const {
    id: idProp,
    contents: contentsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = contentsRecord
      ? { ...initialValues, ...contentsRecord }
      : initialValues;
  ...
  const [contentsRecord, setContentsRecord] = React.useState(contentsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Contents, idProp)
        : contentsModelProp;
      setContentsRecord(record);
    };
    queryData();
  }, [idProp, contentsModelProp]);
  React.useEffect(resetStateValues, [contentsRecord]);
  const validations = {
    title: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Contents.copyOf(contentsRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ContentsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Title"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || contentsModelProp)}
