...
export default function SubMenuUpdateForm(props) {
  const {
    id: idProp,
    subMenu: subMenuModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(SubMenu, idProp)
        : subMenuModelProp;
      setSubMenuRecord(record);
    };
    queryData();
  }, [idProp, subMenuModelProp]);
  React.useEffect(resetStateValues, [subMenuRecord]);
  const validations = {
    name: [{ type: "Required" }],
    link: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            SubMenu.copyOf(subMenuRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "SubMenuUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || subMenuModelProp)}
